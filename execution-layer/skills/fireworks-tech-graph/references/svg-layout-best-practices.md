...
### 1. Component Spacing
- **Minimum clearance between components**: 60px (edge to edge)
- **Minimum clearance for arrow paths**: 50px from component edges
- **Layer vertical spacing**: 90px between horizontal layers
- **Same-layer horizontal spacing**: 80-100px between components
...
- **Background rect**: ALWAYS include, with:
  ...
  - Opacity: 0.9-0.95
- **Safety distance**: 12px minimum from any component edge
...
- **Arrows**: medium (2px), filled polygon markers (12×8)
...
- [ ] Minimum 50px clearance for all arrow paths
...
| Components too close | Increase spacing to 60px minimum |
