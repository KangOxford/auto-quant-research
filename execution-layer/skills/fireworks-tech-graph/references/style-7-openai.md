...
font-size:   20px node labels, 13px descriptions, 14px arrow labels
...
<defs>
  <!-- Default arrow (gray) -->
  <marker id="arrow-oai" markerWidth="12" markerHeight="8" refX="11" refY="4" orient="auto">
    <polygon points="0 0, 12 4, 0 8" fill="#71717a"/>
  </marker>

  <!-- Accent arrow (green) -->
  <marker id="arrow-oai-green" markerWidth="12" markerHeight="8" refX="11" refY="4" orient="auto">
    <polygon points="0 0, 12 4, 0 8" fill="#10a37f"/>
  </marker>
</defs>

<!-- Default connection -->
<line x1="280" y1="140" x2="400" y2="140"
      stroke="#71717a" stroke-width="2" marker-end="url(#arrow-oai)"/>

<!-- Accent connection -->
<line x1="280" y1="140" x2="400" y2="140"
      stroke="#10a37f" stroke-width="2" marker-end="url(#arrow-oai-green)"/>
```

**Arrow guidelines:**
- Prefer straight lines (orthogonal routing with right angles)
- `stroke-width: 2` — clean and precise
...
```xml
<text x="340" y="133" text-anchor="middle" fill="#6e6e80" font-size="14">
  label
</text>
```

Labels should be:
- 14px, gray color (`#6e6e80`)
...
<text x="90" y="97" fill="#6e6e80" font-size="14" font-weight="500">
  Group Label
</text>
```
...
**Content guidelines:**
- 1-2 lines per box
- Main label: 20px, font-weight: 600, near-black
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 480" width="720" height="480">
  ...
  <!-- Title -->
  <text x="360" y="30" text-anchor="middle" fill="#0d0d0d"
  ...
  <text x="190" y="100" text-anchor="middle" fill="#0d0d0d"
        font-size="20" font-weight="600">Component</text>
  ...
  <line x1="280" y1="110" x2="400" y2="110"
        stroke="#71717a" stroke-width="2" marker-end="url(#arrow-oai)"/>
  <text x="340" y="103" text-anchor="middle" fill="#6e6e80" font-size="14">label</text>
</svg>
```
