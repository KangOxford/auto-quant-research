...
font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Helvetica Neue', 
             Arial, sans-serif
font-size:   20px node labels, 16px descriptions, 13px arrow labels
...
1. Component name (bold, 20px)
2. Technical detail or implementation (16px)
3. Key parameter or constraint (16px, optional)
...
```xml
<text x="30" y="130" fill="#6a6a6a" font-size="16" font-weight="600">Input</text>
<text x="30" y="290" fill="#6a6a6a" font-size="16" font-weight="600">Processing</text>
<text x="30" y="490" fill="#6a6a6a" font-size="16" font-weight="600">Storage</text>
```
...
<text x="775" y="560" fill="#6a6a6a" font-size="14">Read operation</text>

<line x1="735" y1="570" x2="765" y2="570" stroke="#5a5a5a" stroke-width="2" stroke-dasharray="5,3"/>
<text x="775" y="575" fill="#6a6a6a" font-size="14">Write operation</text>
```
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 480" 
  ...
  <rect width="720" height="480" fill="#f8f6f3"/>
  ...
  <text x="190" y="145" text-anchor="middle" fill="#1a1a1a" 
        20" font-weight="600">Agent name</text>
