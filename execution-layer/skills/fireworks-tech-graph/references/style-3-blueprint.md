...
<rect width="720" height="480" fill="#0a1628"/>
<rect width="720" height="480" fill="url(#grid)" opacity="0.6"/>
```
...
font-size:   13px labels, 14px annotations, 20px title
...
<polyline points="x1,y1 x2,y1 x2,y2" 
          stroke="#00b4d8" stroke-width="2" fill="none"
          marker-end="url(#arrow-cyan)"/>

<!-- Annotation label on line -->
<text fill="#48cae4" font-size="14" text-anchor="middle">HTTP/REST</text>
```
...
<text x="820" y="542" text-anchor="middle" 
      fill="#caf0f8" font-size="14">SYSTEM ARCHITECTURE</text>
