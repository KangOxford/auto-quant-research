...
Text label:     #6b7280  (gray-500), uppercase, 14px
...
font-size:   16px labels, 14px uppercase type labels, 20px title
...
<text fill="#111827" font-size="16" font-weight="500"/>

<!-- Type label (inside or above box) -->
<text fill="#9ca3af" font-size="14" 
