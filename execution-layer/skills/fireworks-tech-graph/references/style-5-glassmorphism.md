...
<rect width="720" height="480" fill="url(#glow-blue)"/>
<rect width="720" height="480" fill="url(#glow-purple)"/>
```
...
font-size:   16px labels, 14px sublabels, 20px hero title
